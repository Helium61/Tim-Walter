...
<header className="    text-white body-font">
      <div className="bg-slate-900">
        ...
        <div>
            ...
            <div className="text-center text-5xl font-serif italic mt-20">
                <h1>What I offer</h1>
                <h2 className="text-4xl mt-6"> Live sessions</h2>
            </div>
            <div className="flex justify-center items-center h-screen">
          <video controls className="w-{100} h-full mt-32">
            <source
              src="/ITS 2021 - The Event Teaser Trailer.mp4"
              type="video/mp4"
            />
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-slate-800 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6 text-white">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90s microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
